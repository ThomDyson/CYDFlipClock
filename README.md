...
This program uses a Cheap Yellow Display to show a classic flip clock.  The design is based on Mark Wilson's [Simulated Flip Clock](https://github.com/funnypolynomial/FlipClock), but I've updated the code to use modern libraries and a CYD. **Note:** Touch the screen to force a flip.
